-- QueryDef name: BM IY Rule 17 Younger Brother IY Phase 1 Query
...
WHERE (((BIOG_MAIN_1.c_index_year) Is Null Or (BIOG_MAIN_1.c_index_year)=0) And ((KIN_DATA.c_kin_code)=126 Or (KIN_DATA.c_kin_code)=166) And ((InStr(1,BIOG_MAIN.c_notes,'Index year algorithmically'))=0))
