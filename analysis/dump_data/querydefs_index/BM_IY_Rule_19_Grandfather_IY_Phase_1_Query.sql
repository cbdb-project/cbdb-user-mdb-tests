-- QueryDef name: BM IY Rule 19 Grandfather IY Phase 1 Query
...
WHERE (((BIOG_MAIN_1.c_index_year) Is Null Or (BIOG_MAIN_1.c_index_year)=0) And ((KIN_DATA.c_kin_code)=62) And ((InStr(1,BIOG_MAIN.c_notes,'Index year algorithmically'))=0))
