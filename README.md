...
| LookAtNetworks         | ⏭ skipped (CmdRun timeout) | — | ⏭ Recall (CmdRun timeout) | ⏭ ImportPeople / ImportPlaces (CmdRun timeout) | — (no save button) | recursive expansion (Zhu Xi 2 471 assocs); PR AA showed Form_Open opens fine, blocker is CmdRun network expansion, not Form_Open |
